...
public class BinanceRawOrderItemsViewModel implements Parcelable
{
	...
	public BinanceRawOrderItemsViewModel items(List<BinanceRawOrder> items) {
		this.items = items;
		return this;
	}

	public BinanceRawOrderItemsViewModel addItemsItem(BinanceRawOrder itemsItem) {
		if (this.items == null) {
			this.items = new ArrayList<BinanceRawOrder>();
		}
	 ...
	 **/
	@Schema(description = "")
	public List<BinanceRawOrder> getItems() {
		return items;
	}

	public void setItems(List<BinanceRawOrder> items) {
		this.items = items;
	}

	public BinanceRawOrderItemsViewModel total(Integer total) {
		this.total = total;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		BinanceRawOrderItemsViewModel binanceRawOrderItemsViewModel = (BinanceRawOrderItemsViewModel) o;
		return Objects.equals(this.items, binanceRawOrderItemsViewModel.items) &&
				Objects.equals(this.total, binanceRawOrderItemsViewModel.total);
	}
	...
	public String toString() {
		...
		sb.append("class BinanceRawOrderItemsViewModel {\n");
