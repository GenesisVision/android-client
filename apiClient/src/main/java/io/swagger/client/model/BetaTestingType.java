...
/**
 * Gets or Sets BetaTestingType
 */
@JsonAdapter(BetaTestingType.Adapter.class)
public enum BetaTestingType
{
	...
	{
		@Override
		public void write(final JsonWriter jsonWriter, final BetaTestingType enumeration) throws IOException {
