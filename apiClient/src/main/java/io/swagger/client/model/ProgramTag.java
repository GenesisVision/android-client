...
{
	public static final Parcelable.Creator<ProgramTag> CREATOR = new Parcelable.Creator<ProgramTag>()
	{
		public ProgramTag createFromParcel(Parcel in) {
			return new ProgramTag(in);
		}

		public ProgramTag[] newArray(int size) {
			return new ProgramTag[size];
		}
	};
