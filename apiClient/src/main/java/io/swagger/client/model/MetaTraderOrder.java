...
public class MetaTraderOrder
{
	...
	private OffsetDateTime dateOpen = null;

	@SerializedName("dateClose")
	private OffsetDateTime dateClose = null;
	...
	public MetaTraderOrder dateOpen(OffsetDateTime dateOpen) {
	...
	public MetaTraderOrder dateClose(OffsetDateTime dateClose) {
