...
public class NewInvestmentRequest
{
	...
	public NewInvestmentRequest userId(UUID userId) {
		this.userId = userId;
		return this;
	}
	...
	public NewInvestmentRequest dateFrom(OffsetDateTime dateFrom) {
	...
	public NewInvestmentRequest dateTo(OffsetDateTime dateTo) {
		this.dateTo = dateTo;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.userId, newInvestmentRequest.userId) &&
				Objects.equals(this.brokerTradeServerId, newInvestmentRequest.brokerTradeServerId) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash(userId, brokerTradeServerId, tradePlatformPassword, depositAmount, tokenName, tokenSymbol, dateFrom, dateTo, logo, description, feeEntrance, feeManagement, feeSuccess, investMinAmount, investMaxAmount, period);
	}
