...
public class ChangeFundSettingsActivity extends BaseSwipeBackActivity implements ChangeFundSettingsView
{
	...
	public static void startFrom(Activity activity, UUID assetId, ProgramUpdate model) {
		Intent intent = new Intent(activity.getApplicationContext(), ChangeFundSettingsActivity.class);
	...
	@InjectPresenter
	ChangeFundSettingsPresenter presenter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_change_fund_settings);
			...
			if (model != null) {
				...
				if (savedInstanceState == null) {
					getSupportFragmentManager()
							.beginTransaction()
							.add(R.id.content, FundFeesFragment.with(new FundSettingsModel(false, "", "",
									getString(R.string.update), model.getEntryFee(), model.getExitFee(), false)))
