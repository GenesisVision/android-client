...
public class TradingAccountOpenPositionsFragment extends BaseFragment implements TradingAccountOpenPositionsView, TradingAccountDetailsPagerAdapter.OnPageVisibilityChanged
{
	...
	public static TradingAccountOpenPositionsFragment with(UUID accountId) {
		TradingAccountOpenPositionsFragment openPositionsFragment = new TradingAccountOpenPositionsFragment();
	...
	@InjectPresenter
	public TradingAccountOpenPositionsPresenter presenter;
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		return inflater.inflate(R.layout.fragment_trading_account_open_positions, container, false);
	}
