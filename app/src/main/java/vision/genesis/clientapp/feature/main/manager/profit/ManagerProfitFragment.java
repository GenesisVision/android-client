...
public class ManagerProfitFragment extends BaseFragment implements ManagerProfitView, ProgramDetailsPagerAdapter.OnPageVisibilityChanged
{
	private static String EXTRA_MANAGER_ID = "extra_manager_id";

	public static ManagerProfitFragment with(UUID managerId) {
		ManagerProfitFragment managerProfitFragment = new ManagerProfitFragment();
		Bundle arguments = new Bundle(1);
		arguments.putSerializable(EXTRA_MANAGER_ID, managerId);
		managerProfitFragment.setArguments(arguments);
	...
	@InjectPresenter
	public ManagerProfitPresenter managerProfitPresenter;
	...
	public void onDateRangeClicked() {
		if (getActivity() != null) {
			...
			bottomSheetDialog.setListener(managerProfitPresenter);
		}
	}
	...
	public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		...
		managerProfitPresenter.setManagerId((UUID) getArguments().getSerializable(EXTRA_MANAGER_ID));
	...
	public void pagerShow() {
		if (managerProfitPresenter != null)
			managerProfitPresenter.onShow();
	}
