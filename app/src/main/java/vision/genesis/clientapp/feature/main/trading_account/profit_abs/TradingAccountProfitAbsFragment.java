...
public class TradingAccountProfitAbsFragment extends BaseFragment implements TradingAccountProfitAbsView, TradingAccountDetailsPagerAdapter.OnPageVisibilityChanged
{
	private static String EXTRA_ACCOUNT_DETAILS = "extra_account_details";

	public static TradingAccountProfitAbsFragment with(PrivateTradingAccountFull details) {
		TradingAccountProfitAbsFragment tradingAccountProfitAbsFragment = new TradingAccountProfitAbsFragment();
		Bundle arguments = new Bundle(1);
		arguments.putParcelable(EXTRA_ACCOUNT_DETAILS, details);
		tradingAccountProfitAbsFragment.setArguments(arguments);
		return tradingAccountProfitAbsFragment;
	}
	...
	@InjectPresenter
	public TradingAccountProfitAbsPresenter presenter;
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		return inflater.inflate(R.layout.fragment_trading_account_profit_abs, container, false);
	}
