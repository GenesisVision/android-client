...
import vision.genesis.clientapp.feature.main.program.analytics.details.ProgramAnalyticsDetailsBottomSheetFragment;
...
public class ProgramAnalyticsFragment extends BaseFragment implements ProgramAnalyticsView, ProgramDetailsPagerAdapter.OnPageVisibilityChanged
{
	...
	@InjectPresenter
	public ProgramAnalyticsPresenter presenter;

	private ProgramAnalyticsAdapter programAnalyticsAdapter;
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		return inflater.inflate(R.layout.fragment_program_analytics, container, false);
	}
	...
	private void initRecyclerView() {
		...
		programAnalyticsAdapter = new ProgramAnalyticsAdapter(programCurrency, periodDurationDays);
		recyclerView.setAdapter(programAnalyticsAdapter);
	...
	public void setData(List<ProgramPeriodViewModel> periods) {
		...
		programAnalyticsAdapter.setData(periods);
	...
	public void addData(List<ProgramPeriodViewModel> periods) {
		programAnalyticsAdapter.addData(periods);
	}

	@Override
	public void showAnalyticsDetails(ProgramPeriodViewModel period) {
		if (getActivity() != null) {
			ProgramAnalyticsDetailsBottomSheetFragment bottomSheetFragment = new ProgramAnalyticsDetailsBottomSheetFragment();
