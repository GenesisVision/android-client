...
public class AssetsModule
{
	...
	@Provides
	@Singleton
	public FundsManager provideFundsManager(InvestorApi investorApi, ManagerApi managerApi, FundsApi fundsApi) {
		return new FundsManager(investorApi, managerApi, fundsApi);
	}
